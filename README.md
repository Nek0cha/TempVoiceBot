...
- **権限管理** — ロック/プライベート/非表示/BANを組み合わせた一元的な権限制御
...
| `/private` / `/public` | VCを非公開/公開に切り替え |
| `/hide` / `/show` | VCを非表示/表示に切り替え |
...
src/
  ...
  events/
    ...
    interactionCreate.js# コマンド・ボタン・セレクトメニューのルーティング
  utils/
  ...
  commands/
    ...
    owner/              # rename, limit, bitrate, lock, unlock, private,
                        # public, hide, show, kick, ban, invite, claim, transfer
```
